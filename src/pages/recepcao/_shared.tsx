...
export const PRIORIDADE_CONFIG: Record<PrioridadeChamadoResponseAPI, { bg: string; fg: string; label: string; dot: string }> = {
  CRITICA: { bg: "#fff1f2", fg: "#e11d48", label: "Emergência", dot: "#e11d48" },
  ALTA:    { bg: "#fff7ed", fg: "#ea580c", label: "Urgente", dot: "#ea580c" },
  MEDIA:   { bg: "#fefce8", fg: "#854d0e", label: "Moderado", dot: "#ca8a04" },
  BAIXA:   { bg: "#f0fdf4", fg: "#166534", label: "Baixa", dot: "#16a34a" },
};
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        <Box>
          <Typography variant="h5" sx={{ fontWeight: 800, color: TEXT, letterSpacing: "-0.02em" }}>
            {title}
          </Typography>
          {subtitle && (
            <Typography variant="body2" sx={{ color: TEXT_DIM, mt: 0.5, fontWeight: 500 }}>
              {subtitle}
            </Typography>
          )}
        </Box>
